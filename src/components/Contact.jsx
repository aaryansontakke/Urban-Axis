  ...
  const branches = [
    {
      ...
      address: "Address will be update soon",
    ...
    <div className="bg-[#fcfdfe] min-h-screen font-sans text-slate-800 selection:bg-blue-100 overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 mt-12 relative z-30 pb-16">
        ...
        <div className="mt-12 relative group overflow-hidden border-8 border-white shadow-2xl h-[300px] md:h-[400px]">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3730.765245029284!2d78.59240007378848!3d20.76030699694766!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjDCsDQ1JzM3LjEiTiA3OMKwMzUnNDEuOSJF!5e0!3m2!1sen!2sin!4v1778491144292!5m2!1sen!2sin" 
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen=""
